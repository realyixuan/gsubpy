    ...
    testCases := []struct {
    ...
    }{
        {
            ...
            []token.Token{
                ...
                token.Token{Type: token.NUMBER, Literals: "20"},
                token.Token{Type: token.MUL, Literals: "*"},
                token.Token{Type: token.NUMBER, Literals: "10"},
                token.Token{Type: token.DIVIDE, Literals: "/"},
                token.Token{Type: token.NUMBER, Literals: "2"},
                token.Token{Type: token.MINUS, Literals: "-"},
                token.Token{Type: token.NUMBER, Literals: "50"},
    ...
    testCases := []struct{
    ...
    } {
        {
            ...
            []token.Token{
                ...
                token.Token{Type: token.NUMBER, Literals: "5"},
